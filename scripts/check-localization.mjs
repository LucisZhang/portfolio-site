...
try {
  const routes = ["/", "/engineering", "/analytics", "/ai", "/engineering/exactly-once-drills", "/ai/release-guardian", "/ai/rag-quality-lab", "/ai/privacy-preflight-mac", "/analytics/margin-control-tower", "/analytics/credit-policy-desk", "/analytics/analytics-tandem", "/ai/triage-router"];
