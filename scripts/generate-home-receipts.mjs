...
// privacy manifest SHA-256, a build date, and a gate-status line — that the
// task 1.1 adapter (generate-home-data.mjs -> home-stats.json) does not
// carry. Rather than editing that concurrently-owned adapter, this is a
