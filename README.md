# Xiangguo Zhang — Operable Portfolio
...
![Current Xiangguo Zhang portfolio homepage in English](docs/phase2-public-review-artifacts/goal2-final/chrome/en-desktop-home-1440.png)
...
| --- | --- |
| ![Release Guardian top-of-page review capture](docs/phase2-public-review-artifacts/goal2-final/chrome/en-desktop-release-guardian-top-1440.png) | ![Margin Control Tower top-of-page review capture](docs/phase2-public-review-artifacts/goal2-final/chrome/en-desktop-margin-control-tower-top-1440.png) |

These 1440×900 Google Chrome captures show the current identity and page headers; they are review
images, not substitutes for source or machine evidence. The historical
[full screenshot set](docs/phase2-public-review-artifacts/portfolio-upgrade-20260717/screenshots/)
remains available as a dated before-state. Recreate a complete current set from an already-running
production candidate with `npm run capture:public-review`.
