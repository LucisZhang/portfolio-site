...
- The proof gallery keeps English and Chinese synthetic input/output visuals separate. The two
  Chinese redacted PNG previews are deterministic presentation assets generated from the Chinese
  SVG fixtures with fixed blackout geometry; they are not fresh runtime outputs or new redaction
  evidence.
