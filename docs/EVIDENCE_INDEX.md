...
| Current server-only candidate corpus covers the pinned final repositories plus the commit-pinned Round-2 portfolio-site layer | [`manifest.json`](../assistant-knowledge/manifest.json), [`assistant-knowledge.generated.json`](../src/data/assistant-knowledge.generated.json), [`legacy-risk-control-public-boundary.md`](legacy-risk-control-public-boundary.md) | 8 repositories, 198 reviewed source selections, 1,443 bounded chunks; snapshot SHA-256 `ed712206825def7cbd69b8b98c868cc51f5573a33825a412afbcaa1a959ad144`. The R2 layer contributes 146 source selections / 947 chunks across home and ten project routes at local commit `346b8a8`; its public GitHub citation URLs remain publication-gated until that revision is present in the public repository. Risk Control and `ex-solver` remain private and excluded. |
