...
| HEAD-generated Round-3 assistant source ledger | [`manifest.json`](../assistant-knowledge/manifest.json), [`assistant-knowledge.generated.json`](../src/data/assistant-knowledge.generated.json), [`evidence-index-currentness.test.mjs`](../tests/assistant/evidence-index-currentness.test.mjs) | Commit-local ledger: 12 repositories, 233 reviewed source selections, and 1,764 bounded chunks; snapshot SHA-256 `854f4eb09e294d6377a446fb72386ba9021313b7f7cd89fa134af16aebe29cf3`; generated ledger file SHA-256 `31892f20394a4a2e881c44760c28b667c65ae5565bb6bb254a812bd8683d8a0d`. The portfolio-site selection contributes 150 selections / 990 chunks at commit `da094b778e4a66254fa938dfc671cde5c36990d8`. Machine-specific workspace prefixes are replaced in retrieval text while source URLs, line numbers, and original file hashes remain pinned. Counts and hashes describe the committed source ledger, not anonymous availability; citation reachability remains a separate publication gate. Risk Control and `ex-solver` remain private and excluded. |
...
| HEAD-generated Round-3 authored Ask Portfolio presets | [`question-bank.json`](../assistant-knowledge/question-bank.json), [`ask-question-bank.json`](../src/data/generated/ask-question-bank.json), [`ask-preset-answers.json`](../src/data/generated/ask-preset-answers.json), [`ask-question-bank.test.mjs`](../tests/assistant/ask-question-bank.test.mjs) | 12 routes with 37 bilingual questions produce 37 presets / 74 localized authored answers. Generated question projection SHA-256 `32e135063bbf86f417d6f71094b9088c48c3f504ba811af224487e6db6cf4466`; generated answer artifact SHA-256 `d68905bd52b180607c4ea419c694ce0650c722ecb10805d53e936a09ab59743e`. Numeric grounding and citation destinations are machine-checked; the committed artifacts do not establish live-model or anonymous-public availability. |
