...
| HEAD-generated Round-3 assistant source ledger | [`manifest.json`](../assistant-knowledge/manifest.json), [`assistant-knowledge.generated.json`](../src/data/assistant-knowledge.generated.json), [`evidence-index-currentness.test.mjs`](../tests/assistant/evidence-index-currentness.test.mjs) | Commit-local ledger: 12 repositories, 227 reviewed source selections, and 1,727 bounded chunks; snapshot SHA-256 `60b18e135a50d60cb35c045d1ed3fac8c89d6eceaa1207a7a0dbab6738d97fa0`; generated ledger file SHA-256 `1e4dd2493936e2b4d7e22ab42aec7c99c238dc516e31b67de62bffe480ce1063`. The portfolio-site selection contributes 148 selections / 972 chunks at commit `19b9513559cae0b22e31747c0ef878e7b4c93443`. Machine-specific workspace prefixes are replaced in retrieval text while source URLs, line numbers, and original file hashes remain pinned. Counts and hashes describe the committed source ledger, not anonymous availability; citation reachability remains a separate publication gate. Risk Control and `ex-solver` remain private and excluded. |
...
| HEAD-generated Round-3 authored Ask Portfolio presets | [`question-bank.json`](../assistant-knowledge/question-bank.json), [`ask-question-bank.json`](../src/data/generated/ask-question-bank.json), [`ask-preset-answers.json`](../src/data/generated/ask-preset-answers.json), [`ask-question-bank.test.mjs`](../tests/assistant/ask-question-bank.test.mjs) | 12 routes with 37 bilingual questions produce 37 presets / 74 localized authored answers. Generated question projection SHA-256 `32e135063bbf86f417d6f71094b9088c48c3f504ba811af224487e6db6cf4466`; generated answer artifact SHA-256 `b27840259269e684105e613db8a0ec0a3c0adb1586b4d3dc19bb8485249686cf`. Numeric grounding and citation destinations are machine-checked; the committed artifacts do not establish live-model or anonymous-public availability. |
