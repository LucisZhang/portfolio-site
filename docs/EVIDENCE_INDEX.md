...
## Frontier Forge GPU replica and distributed training evidence

| Visible claim | Artifact | Source / reproduction path | Boundary |
| --- | --- | --- | --- |
| Two time-sliced vLLM replicas on one RTX 4090 reached 1.748× / 1.795× single-replica success throughput at QPS 4 / 8 (+37.40 / +19.34 pp success rate; TTFT p95 0.408× / 0.420×); 10 cycles of 0→1→2→1→0 with 1→2 Ready p50 85.37s | [`gpu-scaling-evidence.json`](../public/case-studies/frontier-forge/gpu-scaling-evidence.json) | [`results/phase7_3_summary.md`](https://github.com/LucisZhang/frontier-forge/blob/34e857b417bb9d2767340332ddc1580b7381f334/results/phase7_3_summary.md), source commit `34e857b` | Staged PASS, not one continuous run. The observer's E2E p95 rose 1.65%, but 1,353 of 1,505 attacker requests timed out after HTTP 200; time-slicing is not hard isolation or multi-GPU scaling. |
| On one 2×RTX 4090 machine at QPS 2, TP=2 reached 0.830× TP=1 success throughput with 7.268× TTFT p95 and 1.205× cost per 1K successful tasks | [`gpu-scaling-evidence.json`](../public/case-studies/frontier-forge/gpu-scaling-evidence.json) | [`results/phase7_3_tp_reviewed_report.md`](https://github.com/LucisZhang/frontier-forge/blob/34e857b417bb9d2767340332ddc1580b7381f334/results/phase7_3_tp_reviewed_report.md), source commit `34e857b` | One operating point (n=372 per setting); not a scalability result. |
| Full-parameter SFT of Qwen3.5-0.8B-Base on 2×RTX 4090: 1,706.90 / 3,366.58 / 2,309.85 input tok/s for single GPU / DDP / FSDP (98.62% / 67.66% scaling efficiency); FSDP peak allocated per GPU 55.61% below DDP; hard-AND 98.45% / 98.40% / 98.55% with both paired CIs including zero | [`gpu-scaling-evidence.json`](../public/case-studies/frontier-forge/gpu-scaling-evidence.json) | [`results/phase8_distributed_report.md`](https://github.com/LucisZhang/frontier-forge/blob/34e857b417bb9d2767340332ddc1580b7381f334/results/phase8_distributed_report.md), [`supplement.md`](https://github.com/LucisZhang/frontier-forge/blob/34e857b417bb9d2767340332ddc1580b7381f334/results/phase8/final-publication/supplement.md), source commit `34e857b` | Single machine over a PCIe NODE link without NVLink; communication time not profiled; no multi-node or production claim. |

## Crossover Study engineering evidence

| Visible claim | Artifact | Source / reproduction path | Boundary |
| --- | --- | --- | --- |
| Four existing Iceberg tables registered through Hive Metastore; eight snapshot/time-travel checks; three Spark SQL gold projections matched the PySpark reference with zero bidirectional row differences over 15,473,536 interactions | [`engineering-evidence.json`](../public/case-studies/crossover-study/engineering-evidence.json) | [`docs/hive-gold/README.md`](https://github.com/LucisZhang/crossover-study/blob/a18646d95ab4d32446b723303ab5c3d50e33e173/docs/hive-gold/README.md), source commit `a18646d` | Hive Metastore/Postgres stores catalog metadata; Spark SQL executes the work. This is not Hive on Tez/MapReduce or production-cluster evidence. |
| AQE skew join reduced join-stage task-time max/median from 2.22 to 1.30 on 43,365,424 interactions; broadcast removed the join shuffle | [`engineering-evidence.json`](../public/case-studies/crossover-study/engineering-evidence.json) | [`docs/spark-skew/RESULTS.md`](https://github.com/LucisZhang/crossover-study/blob/a18646d95ab4d32446b723303ab5c3d50e33e173/docs/spark-skew/RESULTS.md), source commit `a18646d` | Three-run elapsed ranges overlap, so no stable end-to-end acceleration is claimed. The broadcast arm's 7,663 B excludes broadcast traffic and is not total network transfer. |
...
| Historical 2026-08-29 Round-2 server-only assistant candidate corpus | Git object `d98941e49abeb6c5bc78659c6a06dc2661515a17:src/data/assistant-knowledge.generated.json`; [`legacy-risk-control-public-boundary.md`](legacy-risk-control-public-boundary.md) | The immutable R2 snapshot covered 8 repositories, 206 reviewed source selections, and 1,410 bounded chunks; snapshot SHA-256 `219791939c5b56f0c44709e05f8b5bb22b2687a9ddec1611b665afb837e484a2`. Its portfolio-site layer contributed 148 selections / 961 chunks at local commit `e8821702bfe69ee5846a617aa178486f216b5346`. This row is retained for provenance and is superseded for HEAD-currentness by the generated ledger below. |
| HEAD-generated Round-3 assistant source ledger | [`manifest.json`](../assistant-knowledge/manifest.json), [`assistant-knowledge.generated.json`](../src/data/assistant-knowledge.generated.json), [`evidence-index-currentness.test.mjs`](../tests/assistant/evidence-index-currentness.test.mjs) | Commit-local ledger: 12 repositories, 231 reviewed source selections, and 1,746 bounded chunks; snapshot SHA-256 `f9f657d45f5321272448eae739e95006cb1fb04259ea41180d649446d22a365e`; generated ledger file SHA-256 `b220fd4ebf012ebebf3a9d7d48dfc5684446aa526d3736fc2bb7304dd34b4b7c`. The portfolio-site selection contributes 148 selections / 972 chunks at commit `19b9513559cae0b22e31747c0ef878e7b4c93443`. Machine-specific workspace prefixes are replaced in retrieval text while source URLs, line numbers, and original file hashes remain pinned. Counts and hashes describe the committed source ledger, not anonymous availability; citation reachability remains a separate publication gate. Risk Control and `ex-solver` remain private and excluded. |
...
| HEAD-generated Round-3 authored Ask Portfolio presets | [`question-bank.json`](../assistant-knowledge/question-bank.json), [`ask-question-bank.json`](../src/data/generated/ask-question-bank.json), [`ask-preset-answers.json`](../src/data/generated/ask-preset-answers.json), [`ask-question-bank.test.mjs`](../tests/assistant/ask-question-bank.test.mjs) | 12 routes with 37 bilingual questions produce 37 presets / 74 localized authored answers. Generated question projection SHA-256 `32e135063bbf86f417d6f71094b9088c48c3f504ba811af224487e6db6cf4466`; generated answer artifact SHA-256 `6b4242007fca9fc7d3c0a9f91edc38ca6e7bb2705954827568f82540e5cdce92`. Numeric grounding and citation destinations are machine-checked; the committed artifacts do not establish live-model or anonymous-public availability. |
