...
// dialogue-genre "Ask Portfolio" page (spec §6.7), matching src/app/ai/
// rag-quality-lab/page.tsx's shape exactly -- see that file's comment for
// why standalone routes exist at all (route-budget: a next/dynamic()
// branch inside the shared [track]/[project] catch-all doesn't actually
// code-split). This route was previously unreachable (routeEnabled: false
