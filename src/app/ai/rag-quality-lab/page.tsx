...
// Task L3 [CLAUDE]: standalone literal route -- see src/app/ai/frontier-
// forge/page.tsx's comment for why this exists (route-budget regression: a
...
// Matches src/app/analytics/margin-control-tower/page.tsx's shape exactly:
