...
// Task L1: standalone literal route -- see src/app/projects/frontier-forge/
// page.tsx's comment for why this exists (route-budget regression: a
// next/dynamic() branch inside the shared project catch-all does not
// actually code-split its chunk away from the other project routes).
