...
// Task L6 [CLAUDE]: standalone literal route -- see src/app/projects/
// frontier-forge/page.tsx's comment for why this exists (route-budget
// regression: next/dynamic() inside the shared project catch-all did not
// actually code-split each page's chunk away from the other project
// routes). Matches src/app/projects/credit-policy-desk/page.tsx's shape,
