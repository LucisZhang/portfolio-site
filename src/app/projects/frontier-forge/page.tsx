...
// branches inside the shared project catch-all (then at
// src/app/[track]/[project]/page.tsx, now src/app/projects/[slug]/page.tsx), reached
...
// (verified directly against the then-current .next/server/app/[track]/
// [project]/page_client-reference-manifest.js -- all four "chunks" arrays
// terminated in the literal page-<hash>.js file). Because that catch-all is
// one compiled entry serving all ten project slugs
...
// the catch-all's dynamic segment (standard Next.js behavior), so
