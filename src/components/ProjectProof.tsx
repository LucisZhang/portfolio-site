...
import TriageProof from "@/components/TriageProof";
...
const proofByProject: Record<ProjectId, () => React.JSX.Element> = {
  ...
  "exactly-once-drills": P1Proof,
  "rag-quality-lab": RagProof,
  "triage-router": TriageProof,
