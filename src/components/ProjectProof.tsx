  ...
  return (
    <Section title={dict.evidence} className="tinted-section">
      ...
      <div className="privacy-macos-status" id="privacy-macos-status">
        ...
        <p>{locale === "en" ? "App ZIP: 33,930,369 bytes · SHA-256 360083a7fab6b60600f597b28a32c533a9df932766c21b80cba80e6c56350911. This build was verified on the build Mac only. It has no Developer ID signature or notarization ticket; Gatekeeper acceptance was not established, so the manual first-open path may be required." : "应用 ZIP：33,930,369 字节 · SHA-256 360083a7fab6b60600f597b28a32c533a9df932766c21b80cba80e6c56350911。本版本仅在构建所用 Mac 上完成验证。它没有 Developer ID 签名或公证票据；尚未证明可通过 Gatekeeper，因此可能需要手动完成首次打开。"}</p>
