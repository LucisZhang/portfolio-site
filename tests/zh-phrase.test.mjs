...
test("zh citation labels space Latin names and not Chinese ones", () => {
  assert.equal(zhCitationLabel("Frontier Forge", "锁定的源码行"), "查看 Frontier Forge：锁定的源码行");
  assert.equal(zhCitationLabel("Release Guardian", "评测证据文件"), "查看 Release Guardian：评测证据文件");
  assert.equal(zhCitationLabel("隐私预检", "架构图"), "查看隐私预检：架构图");
  assert.equal(zhCitationLabel("语音安全", "README 中的已验证结论"), "查看语音安全：README 中的已验证结论");
  assert.equal(zhCitationLabel("章向国作品集", "评测证据文件"), "查看章向国作品集：评测证据文件");
});
