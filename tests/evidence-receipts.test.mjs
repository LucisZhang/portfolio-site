...
const localGroupConvFiles = ["atlas.json", "rtx4090-atlas.json", "current-evidence.md", "provenance.json", "rtx4090-shapes.json", "map-details.json"].map(name => `public/case-studies/groupconv-atlas/${name}`);
