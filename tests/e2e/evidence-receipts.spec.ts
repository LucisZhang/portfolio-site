...
const routes = [
  ["/", "home"],
  ["/ai/frontier-forge", "forge"],
  ["/ai/release-guardian", "guardian"],
  ["/ai/triage-router", "triage"],
  ["/engineering/exactly-once-drills", "eod"],
  ["/engineering/crossover-study", "crossover"],
  ["/ai/rag-quality-lab", "rag"],
  ["/ai/privacy-preflight", "privacy"],
  ["/analytics/margin-control-tower", "margin"],
  ["/analytics/credit-policy-desk", "credit"],
  ["/ai/ask-portfolio", "ask"],
] as const;
