...
export const PROJECT_NAVIGATION = [
  {
    slug: "frontier-forge", route: "/projects/frontier-forge", title: { en: "Frontier Forge", zh: "Frontier Forge" },
  ...
  {
    slug: "exactly-once-drills", route: "/projects/exactly-once-drills", title: { en: "Exactly-Once Drills", zh: "Exactly-Once Drills" },
  ...
  {
    slug: "release-guardian", route: "/projects/release-guardian", title: { en: "Release Guardian", zh: "Release Guardian" },
  ...
  {
    slug: "privacy-preflight", route: "/projects/privacy-preflight", title: { en: "Privacy Preflight", zh: "Privacy Preflight" },
  ...
  {
    slug: "rag-quality-lab", route: "/projects/rag-quality-lab", title: { en: "RAG Quality Lab", zh: "RAG Quality Lab" },
    pos: { en: "GUARD & VERIFY · 03 / 04", zh: "把关与验证 · 03 / 04" },
    group: { id: "guard-verify", anchor: "#index-guard-verify", label: { en: "GUARD & VERIFY", zh: "把关与验证" } },
    nav: { en: ["Drift lab", "Evidence claims", "Source & receipts"], zh: ["漂移实验", "证据声明", "源码与记录"] },
  },
  {
    slug: "ask-portfolio", route: "/projects/ask-portfolio", title: { en: "Ask Portfolio", zh: "Ask Portfolio" },
    pos: { en: "GUARD & VERIFY · 04 / 04", zh: "把关与验证 · 04 / 04" },
    group: { id: "guard-verify", anchor: "#index-guard-verify", label: { en: "GUARD & VERIFY", zh: "把关与验证" } },
    nav: { en: ["The conversation", "How it answers", "Source & report"], zh: ["对话", "回答依据", "源码与报告"] },
  },
  {
    slug: "triage-router", route: "/projects/triage-router", title: { en: "Triage Router", zh: "Triage Router" },
    pos: { en: "MEASURE & DECIDE · 01 / 05", zh: "度量与决策 · 01 / 05" },
  ...
  {
    slug: "crossover-study", route: "/projects/crossover-study", title: { en: "Crossover Study", zh: "Crossover Study" },
    pos: { en: "MEASURE & DECIDE · 02 / 05", zh: "度量与决策 · 02 / 05" },
    group: { id: "measure-decide", anchor: "#index-measure-decide", label: { en: "MEASURE & DECIDE", zh: "度量与决策" } },
    nav: { en: ["SQL workbench", "The two curves", "Source & receipts"], zh: ["SQL 工作台", "两条曲线", "源码与记录"] },
  },
  {
    slug: "margin-control-tower", route: "/projects/margin-control-tower", title: { en: "Margin Control Tower", zh: "Margin Control Tower" },
    pos: { en: "MEASURE & DECIDE · 03 / 05", zh: "度量与决策 · 03 / 05" },
    group: { id: "measure-decide", anchor: "#index-measure-decide", label: { en: "MEASURE & DECIDE", zh: "度量与决策" } },
    nav: {
  ...
  {
    slug: "credit-policy-desk", route: "/projects/credit-policy-desk", title: { en: "Credit Policy Desk", zh: "Credit Policy Desk" },
    pos: { en: "MEASURE & DECIDE · 04 / 05", zh: "度量与决策 · 04 / 05" },
    group: { id: "measure-decide", anchor: "#index-measure-decide", label: { en: "MEASURE & DECIDE", zh: "度量与决策" } },
    nav: {
  ...
  { slug: "groupconv-atlas", route: "/projects/groupconv-atlas", title: { en: "GroupConv Atlas", zh: "GroupConv Atlas" },
    pos: { en: "MEASURE & DECIDE · 05 / 05", zh: "度量与决策 · 05 / 05" },
    group: { id: "measure-decide", anchor: "#index-measure-decide", label: { en: "MEASURE & DECIDE", zh: "度量与决策" } },
    nav: { en: ["Shape atlas", "Kernel design", "Into a module", "Source & receipts"], zh: ["形状地图", "内核设计", "模块实测", "源码与记录"] },
  },
] as const;
