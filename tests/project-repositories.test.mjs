...
const approvedRepositories = {
  "/projects/groupconv-atlas": "groupconv-atlas",
  "/projects/frontier-forge": "frontier-forge",
  "/projects/release-guardian": "release-guardian",
  "/projects/exactly-once-drills": "exactly-once-drills",
  "/projects/rag-quality-lab": "rag-quality-lab",
  "/projects/triage-router": "triage-router",
  "/projects/privacy-preflight": "privacy-preflight",
  "/projects/margin-control-tower": "margin-control-tower",
  "/projects/crossover-study": "crossover-study",
  "/projects/ask-portfolio": "portfolio-site",
  "/projects/credit-policy-desk": "credit-policy-desk",
};
...
test("public routes link only to the approved repository matrix", () => {
  const actual = Object.fromEntries(routableProjects
    ...
    .map((project) => [`/projects/${project.slug}`, project.repository.href]));
