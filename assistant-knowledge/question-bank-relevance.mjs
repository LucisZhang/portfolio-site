// Task R11 (B5-b) [CLAUDE]: the reviewed per-question relevance expectations,
// extracted from tests/assistant/ask-question-bank.test.mjs (task F13a) into a
// shared module so the same reviewed metadata drives BOTH the retrieval gate
// (the test still asserts every question retrieves a chunk from these paths
// matching these claims) and the recorded-answer composition prior in
// scripts/generate-ask-question-bank.mjs (candidates from a reviewed-relevant
...
export const relevantPathsByQuestion = {
  ...
  "release-overview": ["src/lib/projects.ts", "src/components/guardian/guardianData.ts", "docs/evidence/digits-guardian.md"],
  "release-human-approval": ["src/components/guardian/GuardianPage.tsx", "docs/evidence/digits-guardian.md"],
