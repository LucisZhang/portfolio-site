...
![作品集首页桌面评审截图](docs/phase2-public-review-artifacts/portfolio-upgrade-20260717/screenshots/20260717-home-desktop-above-fold.png)
...
| --- | --- |
| ![Release Guardian 完整页面评审截图](docs/phase2-public-review-artifacts/portfolio-upgrade-20260717/screenshots/20260717-project-release-guardian-desktop-full.png) | ![Margin Control Tower 真实数据完整页面评审截图](docs/phase2-public-review-artifacts/portfolio-upgrade-20260717/screenshots/20260717-project-margin-control-tower-real-desktop-full.png) |

这些带日期的图片只用于评审，不能替代当前源码或机器证据。对已经运行的 production
候选执行 `npm run capture:public-review`，可重新生成当前六个案例以及桌面/移动首页截图。
