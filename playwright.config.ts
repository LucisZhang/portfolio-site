...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      name: "iphone-webkit",
      testMatch: ["**/webkit-mobile.spec.ts", "**/circuit-index-groups.spec.ts"],
    ...
    },
    {
      ...
      name: "desktop-webkit",
      testMatch: ["**/keyboard-access.spec.ts", "**/circuit-index-groups.spec.ts"],
    ...
    // desktop Chromium project plus this WebKit project cover the matrix.
    {
      ...
      testMatch: "**/zh-lineation.spec.ts",
      use: { ...devices["Desktop Safari"], viewport: { width: 1440, height: 900 } },
    },
  ],
  webServer: {
